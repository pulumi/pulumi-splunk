...
# Use gotestsum for better output formatting in CI, if available.
# Override locally with: make test GO_TEST_EXEC="go test"
GO_TEST_EXEC ?= go test
ifneq ($(CI),)
GO_TEST_EXEC = gotestsum --format testname --
endif
