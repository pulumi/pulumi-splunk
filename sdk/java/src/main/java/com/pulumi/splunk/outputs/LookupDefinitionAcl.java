...
@CustomType
public final class LookupDefinitionAcl {
    /**
    ...
    public static Builder builder(LookupDefinitionAcl defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> writes;
        public Builder() {}
        public Builder(LookupDefinitionAcl defaults) {
        ...
        public LookupDefinitionAcl build() {
            final var _resultValue = new LookupDefinitionAcl();
