...
@CustomType
public final class SavedEventTypesAcl {
    /**
    ...
    public static Builder builder(SavedEventTypesAcl defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> writes;
        public Builder() {}
        public Builder(SavedEventTypesAcl defaults) {
        ...
        public SavedEventTypesAcl build() {
            final var _resultValue = new SavedEventTypesAcl();
