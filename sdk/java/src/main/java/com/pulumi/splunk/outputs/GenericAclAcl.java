...
@CustomType
public final class GenericAclAcl {
    /**
    ...
    public static Builder builder(GenericAclAcl defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> writes;
        public Builder() {}
        public Builder(GenericAclAcl defaults) {
        ...
        public GenericAclAcl build() {
            final var _resultValue = new GenericAclAcl();
