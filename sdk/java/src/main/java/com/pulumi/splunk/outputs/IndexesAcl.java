...
public final class IndexesAcl {
    ...
    public static Builder builder(IndexesAcl defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> writes;
        public Builder() {}
        public Builder(IndexesAcl defaults) {
        ...
        public IndexesAcl build() {
            final var _resultValue = new IndexesAcl();
