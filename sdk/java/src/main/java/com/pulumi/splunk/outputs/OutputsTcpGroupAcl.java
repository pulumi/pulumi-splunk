...
public final class OutputsTcpGroupAcl {
    ...
    public static Builder builder(OutputsTcpGroupAcl defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> writes;
        public Builder() {}
        public Builder(OutputsTcpGroupAcl defaults) {
        ...
        public OutputsTcpGroupAcl build() {
            final var _resultValue = new OutputsTcpGroupAcl();
