...
public final class AppsLocalAclArgs extends com.pulumi.resources.ResourceArgs {

    public static final AppsLocalAclArgs Empty = new AppsLocalAclArgs();
    ...
    private AppsLocalAclArgs() {}

    private AppsLocalAclArgs(AppsLocalAclArgs $) {
        this.app = $.app;
    ...
    public static Builder builder(AppsLocalAclArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppsLocalAclArgs();
        }

        public Builder(AppsLocalAclArgs defaults) {
            $ = new AppsLocalAclArgs(Objects.requireNonNull(defaults));
        }
