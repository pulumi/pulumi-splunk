...
public final class ShIndexesManagerArgs extends com.pulumi.resources.ResourceArgs {

    public static final ShIndexesManagerArgs Empty = new ShIndexesManagerArgs();
    ...
    private ShIndexesManagerArgs() {}

    private ShIndexesManagerArgs(ShIndexesManagerArgs $) {
        this.acl = $.acl;
    ...
    public static Builder builder(ShIndexesManagerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ShIndexesManagerArgs();
        }

        public Builder(ShIndexesManagerArgs defaults) {
            $ = new ShIndexesManagerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ShIndexesManagerArgs build() {
            return $;
        }
    }
