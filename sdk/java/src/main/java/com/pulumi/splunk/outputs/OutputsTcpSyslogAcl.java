...
@CustomType
public final class OutputsTcpSyslogAcl {
    /**
    ...
    public static Builder builder(OutputsTcpSyslogAcl defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> writes;
        public Builder() {}
        public Builder(OutputsTcpSyslogAcl defaults) {
        ...
        public OutputsTcpSyslogAcl build() {
            final var _resultValue = new OutputsTcpSyslogAcl();
