...
public final class ShIndexesManagerAcl {
    ...
    public static Builder builder(ShIndexesManagerAcl defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> writes;
        public Builder() {}
        public Builder(ShIndexesManagerAcl defaults) {
        ...
        public ShIndexesManagerAcl build() {
            final var _resultValue = new ShIndexesManagerAcl();
