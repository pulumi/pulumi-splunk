...
@CustomType
public final class InputsTcpSplunkTcpTokenAcl {
    ...
    private InputsTcpSplunkTcpTokenAcl() {}
    ...
    public static Builder builder(InputsTcpSplunkTcpTokenAcl defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> writes;
        public Builder() {}
        public Builder(InputsTcpSplunkTcpTokenAcl defaults) {
        ...
        public InputsTcpSplunkTcpTokenAcl build() {
            final var _resultValue = new InputsTcpSplunkTcpTokenAcl();
