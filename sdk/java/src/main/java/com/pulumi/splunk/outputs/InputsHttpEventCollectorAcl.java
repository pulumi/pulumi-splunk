...
@CustomType
public final class InputsHttpEventCollectorAcl {
    ...
    private InputsHttpEventCollectorAcl() {}
    ...
    public static Builder builder(InputsHttpEventCollectorAcl defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> writes;
        public Builder() {}
        public Builder(InputsHttpEventCollectorAcl defaults) {
        ...
        public InputsHttpEventCollectorAcl build() {
            final var _resultValue = new InputsHttpEventCollectorAcl();
