...
public final class InputsTcpRawState extends com.pulumi.resources.ResourceArgs {

    public static final InputsTcpRawState Empty = new InputsTcpRawState();
    ...
    private InputsTcpRawState() {}

    private InputsTcpRawState(InputsTcpRawState $) {
        this.acl = $.acl;
    ...
    public static Builder builder(InputsTcpRawState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InputsTcpRawState();
        }

        public Builder(InputsTcpRawState defaults) {
            $ = new InputsTcpRawState(Objects.requireNonNull(defaults));
        }
