...
public final class InputsTcpSplunkTcpTokenArgs extends com.pulumi.resources.ResourceArgs {

    public static final InputsTcpSplunkTcpTokenArgs Empty = new InputsTcpSplunkTcpTokenArgs();
    ...
    private InputsTcpSplunkTcpTokenArgs() {}

    private InputsTcpSplunkTcpTokenArgs(InputsTcpSplunkTcpTokenArgs $) {
        this.acl = $.acl;
        this.name = $.name;
        this.token = $.token;
    }
    ...
    public static Builder builder(InputsTcpSplunkTcpTokenArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InputsTcpSplunkTcpTokenArgs();
        }

        public Builder(InputsTcpSplunkTcpTokenArgs defaults) {
            $ = new InputsTcpSplunkTcpTokenArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InputsTcpSplunkTcpTokenArgs build() {
            return $;
        }
    }
