...
public class GlobalHttpEventCollector extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="dedicatedIoThreads", type=Integer.class, parameters={})
     ...
     * 
     */
    @Export(name="maxSockets", type=Integer.class, parameters={})
     ...
     * 
     */
    @Export(name="maxThreads", type=Integer.class, parameters={})
     ...
     * 
     */
    @Export(name="useDeploymentServer", type=Integer.class, parameters={})
     ...
     */
    public GlobalHttpEventCollector(String name) {
     ...
     */
    public GlobalHttpEventCollector(String name, @Nullable GlobalHttpEventCollectorArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public GlobalHttpEventCollector(String name, @Nullable GlobalHttpEventCollectorArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("splunk:index/globalHttpEventCollector:GlobalHttpEventCollector", name, args == null ? GlobalHttpEventCollectorArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private GlobalHttpEventCollector(String name, Output<String> id, @Nullable GlobalHttpEventCollectorState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("splunk:index/globalHttpEventCollector:GlobalHttpEventCollector", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static GlobalHttpEventCollector get(String name, Output<String> id, @Nullable GlobalHttpEventCollectorState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
