...
public final class ConfigsConfAclArgs extends com.pulumi.resources.ResourceArgs {

    public static final ConfigsConfAclArgs Empty = new ConfigsConfAclArgs();
    ...
    private ConfigsConfAclArgs() {}

    private ConfigsConfAclArgs(ConfigsConfAclArgs $) {
        this.app = $.app;
    ...
    public static Builder builder(ConfigsConfAclArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ConfigsConfAclArgs();
        }

        public Builder(ConfigsConfAclArgs defaults) {
            $ = new ConfigsConfAclArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ConfigsConfAclArgs build() {
            return $;
        }
    }
