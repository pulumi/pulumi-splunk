...
public final class InputsUdpAclArgs extends com.pulumi.resources.ResourceArgs {

    public static final InputsUdpAclArgs Empty = new InputsUdpAclArgs();
    ...
    private InputsUdpAclArgs() {}

    private InputsUdpAclArgs(InputsUdpAclArgs $) {
        this.app = $.app;
    ...
    public static Builder builder(InputsUdpAclArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InputsUdpAclArgs();
        }

        public Builder(InputsUdpAclArgs defaults) {
            $ = new InputsUdpAclArgs(Objects.requireNonNull(defaults));
        }
