...
public final class OutputsTcpServerAcl {
    ...
    public static Builder builder(OutputsTcpServerAcl defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> writes;
        public Builder() {}
        public Builder(OutputsTcpServerAcl defaults) {
        ...
        public OutputsTcpServerAcl build() {
            final var _resultValue = new OutputsTcpServerAcl();
