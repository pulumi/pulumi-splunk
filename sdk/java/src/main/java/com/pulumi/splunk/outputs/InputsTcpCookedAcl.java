...
public final class InputsTcpCookedAcl {
    ...
    public static Builder builder(InputsTcpCookedAcl defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> writes;
        public Builder() {}
        public Builder(InputsTcpCookedAcl defaults) {
        ...
        public InputsTcpCookedAcl build() {
            final var _resultValue = new InputsTcpCookedAcl();
