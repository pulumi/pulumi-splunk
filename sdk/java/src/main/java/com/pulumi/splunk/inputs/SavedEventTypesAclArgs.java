...
public final class SavedEventTypesAclArgs extends com.pulumi.resources.ResourceArgs {

    public static final SavedEventTypesAclArgs Empty = new SavedEventTypesAclArgs();
    ...
    private SavedEventTypesAclArgs() {}

    private SavedEventTypesAclArgs(SavedEventTypesAclArgs $) {
        this.app = $.app;
    ...
    public static Builder builder(SavedEventTypesAclArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SavedEventTypesAclArgs();
        }

        public Builder(SavedEventTypesAclArgs defaults) {
            $ = new SavedEventTypesAclArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SavedEventTypesAclArgs build() {
            return $;
        }
    }
