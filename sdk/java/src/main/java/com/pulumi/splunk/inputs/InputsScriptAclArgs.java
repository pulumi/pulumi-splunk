...
public final class InputsScriptAclArgs extends com.pulumi.resources.ResourceArgs {

    public static final InputsScriptAclArgs Empty = new InputsScriptAclArgs();
    ...
    private InputsScriptAclArgs() {}

    private InputsScriptAclArgs(InputsScriptAclArgs $) {
        this.app = $.app;
    ...
    public static Builder builder(InputsScriptAclArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InputsScriptAclArgs();
        }

        public Builder(InputsScriptAclArgs defaults) {
            $ = new InputsScriptAclArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InputsScriptAclArgs build() {
            return $;
        }
    }
