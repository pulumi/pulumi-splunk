...
public final class InputsTcpRawAclArgs extends com.pulumi.resources.ResourceArgs {

    public static final InputsTcpRawAclArgs Empty = new InputsTcpRawAclArgs();
    ...
    private InputsTcpRawAclArgs() {}

    private InputsTcpRawAclArgs(InputsTcpRawAclArgs $) {
        this.app = $.app;
    ...
    public static Builder builder(InputsTcpRawAclArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InputsTcpRawAclArgs();
        }

        public Builder(InputsTcpRawAclArgs defaults) {
            $ = new InputsTcpRawAclArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InputsTcpRawAclArgs build() {
            return $;
        }
    }
