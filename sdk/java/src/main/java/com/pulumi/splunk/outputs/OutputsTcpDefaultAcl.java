...
@CustomType
public final class OutputsTcpDefaultAcl {
    ...
    public static Builder builder(OutputsTcpDefaultAcl defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> writes;
        public Builder() {}
        public Builder(OutputsTcpDefaultAcl defaults) {
