...
public final class InputsTcpCookedAclArgs extends com.pulumi.resources.ResourceArgs {

    public static final InputsTcpCookedAclArgs Empty = new InputsTcpCookedAclArgs();
    ...
    private InputsTcpCookedAclArgs() {}

    private InputsTcpCookedAclArgs(InputsTcpCookedAclArgs $) {
        this.app = $.app;
    ...
    public static Builder builder(InputsTcpCookedAclArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(InputsTcpCookedAclArgs defaults) {
            $ = new InputsTcpCookedAclArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InputsTcpCookedAclArgs build() {
            return $;
        }
    }
