...
public final class OutputsTcpSyslogAclArgs extends com.pulumi.resources.ResourceArgs {

    public static final OutputsTcpSyslogAclArgs Empty = new OutputsTcpSyslogAclArgs();
    ...
    private OutputsTcpSyslogAclArgs() {}

    private OutputsTcpSyslogAclArgs(OutputsTcpSyslogAclArgs $) {
        this.app = $.app;
    ...
    public static Builder builder(OutputsTcpSyslogAclArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OutputsTcpSyslogAclArgs();
        }

        public Builder(OutputsTcpSyslogAclArgs defaults) {
            $ = new OutputsTcpSyslogAclArgs(Objects.requireNonNull(defaults));
        }
        ...
        public OutputsTcpSyslogAclArgs build() {
            return $;
        }
    }
