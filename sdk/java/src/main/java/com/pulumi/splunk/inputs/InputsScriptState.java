...
public final class InputsScriptState extends com.pulumi.resources.ResourceArgs {

    public static final InputsScriptState Empty = new InputsScriptState();
    ...
    private InputsScriptState() {}

    private InputsScriptState(InputsScriptState $) {
        this.acl = $.acl;
    ...
    public static Builder builder(InputsScriptState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InputsScriptState();
        }

        public Builder(InputsScriptState defaults) {
            $ = new InputsScriptState(Objects.requireNonNull(defaults));
        }
        ...
        public InputsScriptState build() {
            return $;
        }
    }
