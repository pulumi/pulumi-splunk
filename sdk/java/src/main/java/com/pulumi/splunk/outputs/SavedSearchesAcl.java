...
@CustomType
public final class SavedSearchesAcl {
    ...
    public static Builder builder(SavedSearchesAcl defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> writes;
        public Builder() {}
        public Builder(SavedSearchesAcl defaults) {
        ...
        public SavedSearchesAcl build() {
            final var _resultValue = new SavedSearchesAcl();
