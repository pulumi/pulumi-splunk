...
@CustomType
public final class ConfigsConfAcl {
    /**
    ...
    public static Builder builder(ConfigsConfAcl defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> writes;
        public Builder() {}
        public Builder(ConfigsConfAcl defaults) {
        ...
        public ConfigsConfAcl build() {
            final var _resultValue = new ConfigsConfAcl();
