...
@CustomType
public final class InputsMonitorAcl {
    ...
    public static Builder builder(InputsMonitorAcl defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> writes;
        public Builder() {}
        public Builder(InputsMonitorAcl defaults) {
        ...
        public InputsMonitorAcl build() {
            final var _resultValue = new InputsMonitorAcl();
