...
public final class ConfigsConfState extends com.pulumi.resources.ResourceArgs {

    public static final ConfigsConfState Empty = new ConfigsConfState();
    ...
    private ConfigsConfState() {}

    private ConfigsConfState(ConfigsConfState $) {
        this.acl = $.acl;
        this.name = $.name;
    ...
    public static Builder builder(ConfigsConfState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ConfigsConfState();
        }

        public Builder(ConfigsConfState defaults) {
            $ = new ConfigsConfState(Objects.requireNonNull(defaults));
        }
