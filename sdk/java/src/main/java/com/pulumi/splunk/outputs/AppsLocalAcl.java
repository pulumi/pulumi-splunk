...
@CustomType
public final class AppsLocalAcl {
    /**
    ...
    public static Builder builder(AppsLocalAcl defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> writes;
        public Builder() {}
        public Builder(AppsLocalAcl defaults) {
        ...
        public AppsLocalAcl build() {
            final var _resultValue = new AppsLocalAcl();
