...
public final class OutputsTcpGroupAclArgs extends com.pulumi.resources.ResourceArgs {

    public static final OutputsTcpGroupAclArgs Empty = new OutputsTcpGroupAclArgs();
    ...
    private OutputsTcpGroupAclArgs() {}

    private OutputsTcpGroupAclArgs(OutputsTcpGroupAclArgs $) {
        this.app = $.app;
    ...
    public static Builder builder(OutputsTcpGroupAclArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OutputsTcpGroupAclArgs();
        }

        public Builder(OutputsTcpGroupAclArgs defaults) {
            $ = new OutputsTcpGroupAclArgs(Objects.requireNonNull(defaults));
        }
        ...
        public OutputsTcpGroupAclArgs build() {
            return $;
        }
    }
