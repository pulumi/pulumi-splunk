...
public class InputsUdp extends com.pulumi.resources.CustomResource {
     ...
     */
    public InputsUdp(java.lang.String name) {
     ...
     */
    public InputsUdp(java.lang.String name, @Nullable InputsUdpArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public InputsUdp(java.lang.String name, @Nullable InputsUdpArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("splunk:index/inputsUdp:InputsUdp", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private InputsUdp(java.lang.String name, Output<java.lang.String> id, @Nullable InputsUdpState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("splunk:index/inputsUdp:InputsUdp", name, state, makeResourceOptions(options, id), false);
    }

    private static InputsUdpArgs makeArgs(@Nullable InputsUdpArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? InputsUdpArgs.Empty : args;
    }
     ...
     */
    public static InputsUdp get(java.lang.String name, Output<java.lang.String> id, @Nullable InputsUdpState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
