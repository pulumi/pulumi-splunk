...
public final class GenericAclAclArgs extends com.pulumi.resources.ResourceArgs {

    public static final GenericAclAclArgs Empty = new GenericAclAclArgs();
    ...
    private GenericAclAclArgs() {}

    private GenericAclAclArgs(GenericAclAclArgs $) {
        this.app = $.app;
    ...
    public static Builder builder(GenericAclAclArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GenericAclAclArgs();
        }

        public Builder(GenericAclAclArgs defaults) {
            $ = new GenericAclAclArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GenericAclAclArgs build() {
            return $;
        }
    }
