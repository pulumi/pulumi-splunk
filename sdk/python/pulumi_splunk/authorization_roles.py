...
class AuthorizationRoles(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['cumulative_realtime_search_jobs_quota'] = cumulative_realtime_search_jobs_quota
            __props__['cumulative_search_jobs_quota'] = cumulative_search_jobs_quota
            __props__['default_app'] = default_app
            __props__['imported_roles'] = imported_roles
            __props__['name'] = name
            __props__['realtime_search_jobs_quota'] = realtime_search_jobs_quota
            __props__['search_disk_quota'] = search_disk_quota
            __props__['search_filter'] = search_filter
            __props__['search_indexes_alloweds'] = search_indexes_alloweds
            __props__['search_indexes_defaults'] = search_indexes_defaults
            __props__['search_jobs_quota'] = search_jobs_quota
            __props__['search_time_win'] = search_time_win
